...
public class Yandex : MonoBehaviour
{
    ...
    */
    ...
    [SerializeField] private LevelControl uiControl;
    ...
    public void ClickAdwButton()
    {
        if (uiControl != null)
        {
            //uiControl.SoundPause();
            //uiControl.ButtonAdvInteractable(false);
        }
        //soundFone.Pause();
    ...
    public void AddRewardBonus(int value)
    {
        ...
        GameStart();
        //uiControl.ChangeSimpleFigure();
        
        //uiControl.Generate3AdsTail(value);
    ...
    {
        //if (uiControl != null) uiControl.SoundPlay();
    }
